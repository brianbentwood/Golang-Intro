...
/*
var (
	mapapiKey       = flag.String("key", "AIzaSyB1CYo3hHFIxnL1LDCGTjVC_5Y1TP9dMo8", "API Key for using Google Maps API.")
	mapclientID     = flag.String("client_id", "", "ClientID for Maps for Work API access.")
	mapsignature    = flag.String("signature", "", "Signature for Maps for Work API access.")
	mapaddress      = flag.String("address", "", "The street address that you want to geocode, in the format used by the national postal service of the country concerned.")
	mapcomponents   = flag.String("components", "", "A component filter for which you wish to obtain a geocode.")
	mapbounds       = flag.String("bounds", "", "The bounding box of the viewport within which to bias geocode results more prominently.")
	maplanguage     = flag.String("language", "", "The language in which to return results.")
	mapregion       = flag.String("region", "", "The region code, specified as a ccTLD two-character value.")
	maplatlng       = flag.String("latlng", "", "The textual latitude/longitude value for which you wish to obtain the closest, human-readable address.")
	mapresultType   = flag.String("result_type", "", "One or more address types, separated by a pipe (|).")
	maplocationType = flag.String("location_type", "", "One or more location types, separated by a pipe (|).")
)
*/
